...
function App() {
  ...
  const { company, user, currentAssessment, kpiMetrics, recentActivities, alerts } = data;

  // Get maturity level emoji
      ...
      <header className="app-header">
        <div className="header-content">
          <div className="logo-section">
            <h1>🧭 BUSULA</h1>
            <p className="tagline">Your Startup Business Compass</p>
          </div>
          <div className="user-section">
            <p className="company-name">{company.name}</p>
            <p className="user-name">{user.name} • {user.role}</p>
          </div>
        </div>
      </header>
